...
export function Avatar({ name, count, active, className, size = 'md', showName = false }: AvatarProps) {
  ...
  return (
    <div className={clsx("flex flex-col items-center shrink-0 z-50", className)}>
